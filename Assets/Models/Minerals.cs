...
namespace CavemanLand.Models
{
    public class Minerals
    {
        ...
        private static void populateMetalAbundances()
        {
            ...
            metalAbundances.Add("Marble", .0000021); // Made this up
            metalAbundances.Add("Obsidian", .0000015); // Made this up
            metalAbundances.Add("Gems", .00000105); // Made this up
        ...
        {
            string output = HashPrinter.printHash<string, double>("surface minerals", surface);
            output += "\n" + HashPrinter.printHash<string, double>("minable minerals", mineable);
            return output;
        }
