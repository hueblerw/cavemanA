...
namespace CavemanLand.UnitTests
{
    ...
    public class LayerGeneratorTestClass
    {
        ...
        public void ArrayTest()
        {
            ...
            double[,] array = layerGenerator.GenerateWorldLayer(40, 80, 3.0, 45, false, LayerGenerator.mapPoles.None);
            printArray(array);
        ...
        {
            LayerGenerator layerGenerator = new LayerGenerator(60, 50, 2);
            double[,] squaredArray = layerGenerator.GenerateWorldLayer(40, 80, 3.0, 45, true, LayerGenerator.mapPoles.None);
        ...
        [Test()]
        public void IntNorthPoledArrayTest()
        {
            LayerGenerator layerGenerator = new LayerGenerator(60, 50, 0);
            double[,] array = layerGenerator.GenerateWorldLayer(40, 80, 3.0, 45, false, LayerGenerator.mapPoles.North);
            int[,] intArray = layerGenerator.convertDoubleArrayToInt(array);
            printArray(intArray);
            // Console.WriteLine("Normal 60 x 50 layer generation took: " + stopwatch.Elapsed + "secs.");
            Assert.AreEqual(45, intArray[0, 0]);
        ...
        [Test()]
        public void IntSouthPoledArrayTest()
        {
            LayerGenerator layerGenerator = new LayerGenerator(60, 50, 0);
            double[,] array = layerGenerator.GenerateWorldLayer(40, 80, 3.0, 45, false, LayerGenerator.mapPoles.South);
            int[,] intArray = layerGenerator.convertDoubleArrayToInt(array);
            printArray(intArray);
            // Console.WriteLine("Normal 60 x 50 layer generation took: " + stopwatch.Elapsed + "secs.");
            Assert.AreEqual(45, intArray[0, 0]);
